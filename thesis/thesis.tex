...
Blöcke die bei Zeile 12 und Zeile 24 beginnen). In der Beispieldatei
...
in Zeile 10 zu sehen. Hier ist beispielhaft der String \emph{invalid}
...
\begin{lstlisting}[caption={Nicht vollständiger Auszug aus der Testdatei
 für den CIFS Parser},label={lst:parsertest}]
[...]
...
\emph{structs} und Hashmaps in der Datei \path{cifs.go}.
\begin{minipage}{\linewidth}
