...
\end{itemize}
Durch den dezentralen Ansatz muss der Entwickler außerdem nicht
...
Revisionen oder \emph{Commits} werden durch die lokale Speicherung von
\glspl{blob} erfasst. Das gesamte \emph{Repository} kann auf einen oder
mehrere entfernte Server gesichert werden\cite{GITOTTO}.
\section*{Prototyp}
