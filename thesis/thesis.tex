...
Medium verbunden und bilden so ein Computernetzwerk. \autoref{fig:2}
...
\begin{figure}[H]
    ...
    Systeme mit diversen Anwendungen über ein physisches Medium}\label{fig:2}
\end{figure}
...
\begin{figure}[H]
    ...
    verwendeten Einheiten}\label{fig:3}
\end{figure}
...
\autoref{fig:4} veranschaulicht, die Gliederung dieses \gls{fqdn} in die
...
\autoref{fig:5} zeigt den Aufbau eines solchen \gls{smb}\hyp{}Pakets mit
...
\begin{figure}[h]
    ...
    \begin{bytefield}{32}
        ...
        \bitbox{32}{\ldots}
    \end{bytefield}
    \caption{Aufbau eines \gls{smb}\hyp{}Pakets}\label{fig:5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Zusammenspiel aller Systemkomponenten}\label{fig:6}
\end{figure}
\section*{Datenmodell}
