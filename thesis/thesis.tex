...
\autoref{fig:2} zeigt den Aufbau eines solchen \gls{smb}\hyp{}Pakets mit
\gls{tcp}\hyp{}Header. Der Header beginnt mit einem Byte aus Nullen und
der anschließenden Länge des \smb{SMB}\hyp{}Pakets. Danach kommt in 32
...
\begin{figure}[h]
    ...
    \begin{bytefield}{32}
        ...
        \bitbox{32}{\ldots}
    \end{bytefield}
    \caption{Aufbau eines \gls{smb}\hyp{}Pakets}\label{fig:2}
\end{figure}
...
\begin{tabular}{p{0.7\textwidth-\tabcolsep}>{\raggedleft\arraybackslash}p{0.3\textwidth-\tabcolsep}}\toprule
	...
	\multicolumn{2}{p{\textwidth-\tabcolsep}}{%
        Das System muss in der Lage sein Bandbreitenmessungen anhand des
