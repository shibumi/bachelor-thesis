...
abgeleitet, dass ein manuelles Eingeben von \gls{ip}\hyph{}adressen mit
steigender Anzahl von Knoten im Netzwerk immer unübersichtlicher wurde.
Hinzukommend sind \gls{ip}\hyph{}Adressen für den Menschen schwer zu
merken. Mit dieser Problemstellung als Grundlage arbeitete der Ingenieur
Peter Mockapetris an einem ersten Lösungsansatz: \gls{dns}.
...
merkbare Internetadressen auf \gls{ip}\hyph{}Adressen abbildet.
...
Damals befanden sich die \gls{dns}\hyph{}Einträge, die Abbildungen von
lesbarer Adresse auf \gls{ip}\hyph{}Adresse, noch verteilt auf
allen Servern des frühen Internets, wurden von der \gls{nic} verwaltet
...
der Fall gewesen ist. Anstatt die \gls{dns}\hyph{}Einträge auf allen
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/dnsname.pdf}
