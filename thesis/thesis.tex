...
nicht\hyp{}funktionalen Anforderungen dagegen sind besonders. Sie umfassen
...
und nicht\hyp{}funktionalen Anforderungen besser einordnen zu können, werden
...
Einige Exemplare dieser Bachelorarbeit beinhalten eine Daten\hyp{}CD mit
allen projektrelevanten Dateien. Diese Daten\hyp{}CD hat den folgenden
Aufbau:
...
Die Datei \emph{README.md} auf dieser Daten\hyp{}CD beschreibt den
Inhalt der Daten\hyp{}CD genauer und gibt Anweisungen zur Installation
des Projekts. Das Verzeichnis \emph{sourcecode} beinhaltet den
kompletten Quelltext zu dem Projekt
(\emph{Ansible}\hyp{}Konfigurationsdateien,
\emph{Vagrant}\hyp{}Konfigurationsdateien, Programmcode für die
\emph{Prometheus}\hyp{}Komponente \emph{procfs},
Beispiel\hyp{}Konfigurationsdateien für \emph{OpenSSH} etc). Das
Verzeichnis \emph{thesis} beinhaltet den Latex\hyp{}Quelltext zu dieser
Bachelorarbeit. Das Verzeichnis \emph{transaction} beinhaltet einen
ersten Entwurf eines \emph{Abstracts}.
\nocite{*}
\printbibliography{}
\lstlistoflistings{}
\listoftables{}
