...
\autoref{fig:1} zeigt die aktuelle Netzstruktur der \gls{tuc}. Zu sehen
...
der \gls{tuc} dar und verkünden die Routen zwischen den einzelnen
am Netz angeschlossenen Geräten. Sie trennen außerdem das Netz in
logische Abschnitte. Zu sehen ist ebenfalls das aktuell existierende
...
\begin{figure}[H]
    ...
    \caption{Veranschaulichung der Problemstellung}\label{fig:1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/problemloesung.pdf}
    \caption{Veranschaulichung der Problemlösung}\label{fig:2}
\end{figure}
...
Medium verbunden und bilden so ein Computernetzwerk. \autoref{fig:3}
...
\begin{figure}[H]
    ...
    Systeme mit diversen Anwendungen über ein physisches Medium}\label{fig:3}
\end{figure}
...
\autoref{fig:4} listet alle sieben Schichten, deren Protokolle,
...
\begin{figure}[H]
    ...
    verwendeten Einheiten}\label{fig:4}
\end{figure}
...
\autoref{fig:5} veranschaulicht, die Gliederung dieses \gls{fqdn} in die
...
\autoref{fig:6} zeigt den Aufbau eines solchen \gls{smb}\hyp{}Pakets mit
...
\begin{figure}[h]
    ...
    \begin{bytefield}{32}
        ...
        \bitbox{32}{\ldots}
    \end{bytefield}
    \caption{Aufbau eines \gls{smb}\hyp{}Pakets}\label{fig:6}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Zusammenspiel aller Systemkomponenten}\label{fig:7}
\end{figure}
\section*{Datenmodell}
...
gespeichert in großen Binärdateien (kurz BLOB für Binary Large Object)
...
jedem Gebiet zum einsetzt wo große Mengen zeitlichabhängige Daten für
kurze Zeit oder einen längeren Zeitraum gespeichert werden müssen.
...
festen Zeitpunkt zugeordnet. Dies macht eine \gls{tsdb} besonders beliebt
als Datenbank für Wetterdaten, Aktienhandel, Messdaten oder sonstige
Daten die abhängig von der Zeit und in besonders großen Mengen
...
\addcontentsline{toc}{subsection}{Wahl der Datenbank}
\section*{Wahl der Monitoring Plattform}
\addcontentsline{toc}{section}{Wahl der Monitoring Plattform}
\section*{Wahl der Visualisierungslösung}
\addcontentsline{toc}{section}{Wahl der Visualisierungslösung}
\section*{Wahl des Configuration-Management}
\addcontentsline{toc}{section}{Wahl des Configuration-Management}
